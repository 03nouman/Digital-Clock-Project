...
function setTime() {
  ...
  if (morningTime == hrTime1) {
    document.querySelector("#box5").style.backgroundImage = "url(./good\ morning.png)";
    ...
    document.getElementById("box5").style.backgroundImage = " url(./evening\ image.png)";
    ...
    document.querySelector("#box5").style.backgroundImage = " url(./Assets/constant-img.jpg)";
